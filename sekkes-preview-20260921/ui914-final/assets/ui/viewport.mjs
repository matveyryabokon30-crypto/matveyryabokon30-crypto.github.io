...
export function lockViewport(signal){
 ...
 const update=()=>{const v=window.visualViewport;root.style.setProperty('--keyboard-inset',keyboardInset({height:innerHeight,visualHeight:v?.height||innerHeight,offsetTop:v?.offsetTop||0,scale:v?.scale||1,editing:!!document.activeElement?.matches('input,textarea,select')})+'px')};

import {initialSession,transitionSession} from './foundation.mjs?v=2026.09.19-p23-stage.2';
import {TechnicalLog,greetingCommand} from './protocol.mjs?v=2026.09.19-p23-stage.2';

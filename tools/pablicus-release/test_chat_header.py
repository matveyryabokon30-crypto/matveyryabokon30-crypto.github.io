...
with sync_playwright() as pw:
 ...
 check('identity has no application blur',page.locator('.chatAvatarDock').evaluate('(n)=>[n,...n.children].every(e=>getComputedStyle(e).filter==="none"&&getComputedStyle(e).backdropFilter==="none")'))

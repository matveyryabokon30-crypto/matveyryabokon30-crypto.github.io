...
def tight(page,label):
 ...
 check(label,result['natural'][0]>0 and result['ratioError']<.005 and result['boxError']<1 and result['h']<=321 and result['radius']==16 and result['bottomRadius']==16 and result['clip']!='none' and not result['drag'] and result['fit']=='contain',result)

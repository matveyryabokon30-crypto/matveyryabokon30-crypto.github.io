...
(() => {'use strict';
 ...
 class TransportStore extends OutboxVault.OutboxStore {
  ...
  async renew(id,owner){return this.change(id,r=>{if(!live(r)||r.state!=='sending'||r.lease?.owner!==owner)return false;r.lease.until=Date.now()+60000;});}

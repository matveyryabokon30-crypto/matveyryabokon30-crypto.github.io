...
(function(g){
 ...
 const stats={imageDownloads:0,downloadBytes:0,memoryHits:0,diskHits:0,signRequests:0,coalesced:0,errors:0,peakDownloads:0,evictions:0,diskWrites:0,diskErrors:0,lastDiskError:null,serverPreviews:0,sourceBytesAvoided:0,parallelDiskReads:0,previewFallbacks:0,homeProofHits:0,screenProofHits:0};
 ...
 function resolve(bucket,path,options={}){
  ...
  const job=(async()=>{
   try{
    ...
    const screenProof=g.PablicusScreenData?.proof(bucket,path,width);

...
import {VoiceIdentityHandshake} from './voice-identity.mjs?v=2026.09.20-ui.8.3';
...
function endLive(message){
 ...
 closing=(async()=>{
  try{
   ...
   await release;recoveryNeeded=false;status('Разговор завершён');
  }

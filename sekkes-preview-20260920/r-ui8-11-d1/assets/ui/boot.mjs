...
if(new URLSearchParams(location.search).get('ui')==='classic'){
 ...
 else try{await import('../voice-s3-0.mjs?v=2026.09.20-ui.8.11-d1')}catch{window.SekkesUI.status('Не удалось загрузить модуль разговора. Проверь сеть и обнови приложение.')}
}

...
import {VoiceIdentityHandshake} from './voice-identity.mjs?v=2026.09.20-ui.8.4';
...
function endLive(message){
 ...
 const x=live;
 if(!x){if(startup){disposeTransport(startup);voiceControls('idle');status('');}return Promise.resolve();}

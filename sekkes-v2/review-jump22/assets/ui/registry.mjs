export const sections=Object.freeze([
 {id:'admin',title:'Админ',icon:'settings',route:'#admin',ownerOnly:true,loadModule:()=>import('/sekkes-v2/review-jump22/assets/ui/owner-workspace.mjs')},
 {id:'home',title:'Главная',icon:'home',route:'#home',capability:'conversation',themeRole:'scene',loadModule:()=>import('/sekkes-v2/review-jump22/assets/ui/screens/home.mjs')},

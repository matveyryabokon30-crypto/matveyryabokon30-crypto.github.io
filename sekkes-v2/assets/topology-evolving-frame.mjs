...
export function installEvolving(win,doc){
 ...
 let sketch=null,ready=false,disposed=false,resizeTimer=0,field=null,particles=null,ages=null,cloth=null,trails=null,trailCx=null,cx,width=1,height=1,frame=0;

...
export function voiceTrace(event,code=''){
 ...
 try{localStorage.setItem(KEY,JSON.stringify({version:'voice.64',startedAt:origin,entries,history}));}catch{}
}

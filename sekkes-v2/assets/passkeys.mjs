...
(function (root, factory) {
  ...
  else root.SekkesPasskeys = factory();
})(typeof globalThis !== 'undefined' ? globalThis : this, function () {
  'use strict';
  const messages = Object.freeze({
    unavailable: 'Вход с ключом доступа ещё подключается.',
    unsupported: 'Этот браузер не поддерживает ключи доступа. Войдите другим способом или откройте Sekkes в Safari или Chrome.',
    insecure: 'Ключ доступа работает только на защищённом адресе Sekkes. Откройте сайт по HTTPS.',
    ...
    cancelled: 'Действие отменено или время ожидания истекло. Можно попробовать снова. Если ключ AI Marius ещё не создан, сначала привяжи его к аккаунту.',
    ...
    origin: 'Ключ доступа недоступен на этом адресе. Откройте основной адрес Sekkes.',
...
export const SekkesPasskeys = globalThis.SekkesPasskeys;

...
if(new URLSearchParams(location.search).get('ui')==='classic'){
 ...
 else try{await import('../voice-s3-0.mjs?v=2026.09.21-ui.9.13')}catch{window.SekkesUI.status('Не удалось загрузить модуль разговора. Проверь сеть и обнови приложение.')}
}

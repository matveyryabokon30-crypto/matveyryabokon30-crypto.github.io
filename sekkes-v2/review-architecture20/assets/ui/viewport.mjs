...
export function lockViewport(signal){
 ...
 function rotate(){closing=false;document.activeElement?.matches('input,textarea,select')&&document.activeElement.blur();document.dispatchEvent(new Event('sekkes-orientation-reset'));settle()}

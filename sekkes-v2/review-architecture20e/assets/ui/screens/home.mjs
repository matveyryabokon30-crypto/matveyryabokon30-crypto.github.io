...
import {createTimeline} from '/sekkes-v2/review-architecture20e/assets/ui/chat/timeline.mjs';
export function create(ctx){
 ...
 node.append(conversation);ctx.messages=messages;ctx.timeline=timeline;ctx.flushMessages();if(messages.children.length)showConversation();
